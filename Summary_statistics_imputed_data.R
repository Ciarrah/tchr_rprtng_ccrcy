...
completeddata$Scl_clss_pat=as.factor(completeddata$Scl_clss_pat)
length(which(completeddata$Scl_clss_pat==levels(completeddata$Scl_clss_pat)[1]))/length(which(completeddata$Scl_clss_pat%in%levels(completeddata$Scl_clss_pat)))
length(which(completeddata$Scl_clss_pat==levels(completeddata$Scl_clss_pat)[2]))/length(which(completeddata$Scl_clss_pat%in%levels(completeddata$Scl_clss_pat)))
length(which(completeddata$Scl_clss_pat==levels(completeddata$Scl_clss_pat)[3]))/length(which(completeddata$Scl_clss_pat%in%levels(completeddata$Scl_clss_pat)))
length(which(completeddata$Scl_clss_pat==levels(completeddata$Scl_clss_pat)[4]))/length(which(completeddata$Scl_clss_pat%in%levels(completeddata$Scl_clss_pat)))
length(which(completeddata$Scl_clss_pat==levels(completeddata$Scl_clss_pat)[5]))/length(which(completeddata$Scl_clss_pat%in%levels(completeddata$Scl_clss_pat)))
length(which(completeddata$Scl_clss_pat==levels(completeddata$Scl_clss_pat)[6]))/length(which(completeddata$Scl_clss_pat%in%levels(completeddata$Scl_clss_pat)))
length(which(completeddata$Scl_clss_pat==levels(completeddata$Scl_clss_pat)[1]))
length(which(completeddata$Scl_clss_pat==levels(completeddata$Scl_clss_pat)[2]))
length(which(completeddata$Scl_clss_pat==levels(completeddata$Scl_clss_pat)[3]))
length(which(completeddata$Scl_clss_pat==levels(completeddata$Scl_clss_pat)[4]))
length(which(completeddata$Scl_clss_pat==levels(completeddata$Scl_clss_pat)[5]))
length(which(completeddata$Scl_clss_pat==levels(completeddata$Scl_clss_pat)[6]))
